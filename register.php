      ...
      <div class="container-fluid page-body-wrapper full-page-wrapper">
        <div class="row w-100 m-0">
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            <div class="card col-lg-4 mx-auto" style="font-family:cursive; background-color:white;background:transparent;">
              <div class="card-body px-5 py-5">
                <h3 class="card-title text-left mb-3"  style="font-family:cursive; color:black">REGISTER</h3>
        <form action="controller/register.php" method="post"class="pt-3">
                <div class="form-group">
                    <label style="font-family:cursive; color:black;background:transparent;">Username</label>
                    <input type="text" style="font-family:cursive; color:black;background:transparent;"  pattern="[A-Za-z]+"  name="name" class="form-control p_input" required>
                  </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label style="font-family:cursive; color:black;background:transparent;">Address</label>
                    <input type="text" style="font-family:cursive; color:black;background:transparent;" name="add" class="form-control p_input" required>
                  </div>
                <div class="form-group">
                ...
                <div class="mb-4">
                  <div class="form-check">
                    <label class="form-check-label " style="font-family:cursive; color:black;background:transparent;">
                ...
                <div class="mt-3">
                  <button type="submit" style="font-family:cursive; color:black" name="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">SIGN UP</button>
                </div>
                <div class="text-center mt-4 font-weight-light" style="font-family:cursive; color:black">
                  Already have an account? <a href="login.php" style="font-family:cursive; color:black" class="text-primary">Login</a>
                </div>
              </form>
            </div>
          </div>
