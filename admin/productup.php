...
$id = $_GET['upid'];
$s = $admin->ret("SELECT * FROM `product` INNER JOIN `category` ON `category`.`cat_id`=`product`.`cat_id` WHERE `product`.`p_id`='$id'");
                  ...
                  <div class="col-sm-12 p-0">
                     <div class="main-header">
                        ...
                        <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                           ...
                           <li class="breadcrumb-item"><a href="form-elements-bootstrap.html">Product</a>
                           </li>
                        </ol>
                     </div>
                  </div>
               ...
               <div class="card-header">
                        ...
                        ?>
                           <div class="form-group">
                                 ...
                                 <input type="hidden" name="pid" class="form-control" value="<?php echo $r['p_id'] ; ?>" required="required" placeholder="Enter Product Name">  
                                 
                                 <input type="text" name="name" class="form-control" value="<?php echo $r['p_name'] ; ?>" required="required" placeholder="Enter Product Name">  
                               ...
                               <br>
                                 ...
                                 <input type="text" name="price" value="<?php echo $r['p_price'] ; ?>" class="form-control" required="required" placeholder="Enter Product Name">  
                                 <!-- <div class="form-group"> --><br>


                                 <label for="exampleTextarea" class="form-control-label">Description</label>
                                 <textarea name="des"  class="form-control" id="exampleTextarea" rows="4"><?php echo $r['p_description'] ; ?></textarea>
                                 
                                 <br>
                                 <label for="exampleTextarea" class="form-control-label">Product Image</label> &nbsp; &nbsp;
                              <input type="file" class="form-control" name="img" ></input>
                                 

                              </div>
                              
                              <button type="submit" name="uppro" class="btn btn-success waves-effect waves-light m-r-30 submit">Submit</button>
