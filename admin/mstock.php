                  ...
                  <div class="col-sm-12 p-0">
                     <div class="main-header">
                        ...
                        <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                           ...
                           <li class="breadcrumb-item"><a href="form-elements-bootstrap.html">Stock</a>
                           </li>
                        </ol>
                     </div>
                  </div>
                     ...
                     <div class="card-block">
                        <div class="table-responsive">
                           <table class="table m-b-0 photo-table">
                             ...
                             <a href="stockup.php?upid=<?php echo $row['p_id'] ; ?>"> <button type="submit" class="btn btn-success waves-effect waves-light m-r-10 submit">Update</button></a>
