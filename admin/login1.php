...
<html lang="en">
<head>
	<title>HAFEEZ ENTERPRISES - DRY FRUITS AND SPICES</title>
			...
			<div class="col-sm-12">
				<div class="login-card card-block">
					<div class="md-float-material">
						...
						<div class="row">
						<form action="../controller/adminlog.php" method="post">
							<div class="col-md-12">
							...
							<div class="col-md-12">
								<div class="md-input-wrapper">
									<input type="password" name="pass" class="md-form-control" required="required"/>
						...
						<div class="row">
							<div class="col-xs-10 offset-xs-1">
								<button type="submit" name="log1" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20 submit">LOGIN</button>
							</div>
						</div>
						</form>
