<header class="main-header-top hidden-print">
         <!-- <a href="index.html" class="logo"><img class="img-fluid able-logo" src="assets/images/" alt="logo"></a> -->
...
<!--                     
                  ...
                  <li class="dropdown">
                     ...
                     <ul class="dropdown-menu settings-menu">
                        ...
                        <li><a href="../controller/alogout.php"><i class="icon-logout"></i> Logout</a></li>
