...
<div class="row">
               ...
               <div class="card-header">
                           ...
                           <form action="../controller/cmanage.php" method="post">
                              ...
                              <button type="submit" name="cat" class="btn btn-success waves-effect waves-light m-r-30 submit">Submit</button>
                           </form>
                        </div>
                        </div>
                     </div>
                              ...
                              <tbody>
                                ...
                                while($row = $stmt->fetch(PDO::FETCH_ASSOC)){ ?>
                                 ...
                                 <tr>
                                    ...
                                    <td><?php echo $row['cat_date'] ; ?>  
                                    </td> 
                                    
                                    <td>
                             <a href="../controller/cmanage.php?did=<?php echo $row['cat_id'] ; ?>"> <button type="submit" class="btn btn-danger waves-effect waves-light m-r-10 submit">Delete</button></a>
                              
                             <a href="updatecat.php?upid=<?php echo $row['cat_id'] ; ?>"> <button type="submit" class="btn btn-success waves-effect waves-light m-r-10 submit">Update</button></a>
